...
- [Source: _bmad-output/planning-artifacts/prd.md#FR-41] - Installation via npx in under 5 minutes
- [Source: _bmad-output/planning-artifacts/prd.md#FR-42] - First ticket within 30 minutes
- [Source: _bmad-output/planning-artifacts/prd.md#SC-9] - Time-to-first-value metric
- [Source: _bmad-output/planning-artifacts/prd.md#SC-10] - Zero-knowledge onboarding
- [Source: _bmad-output/planning-artifacts/prd.md#SC-16] - Repeat usage success criterion
- [Source: _bmad-output/planning-artifacts/epics.md#Story-1.6] - Epic story requirements
- [Source: _bmad-output/planning-artifacts/architecture.md#Extension Model] - File-based extension mechanism
...
**Story File:**
- `_bmad-output/implementation-artifacts/1-6-verify-align-installation-onboarding.md` - Story specification and implementation record
