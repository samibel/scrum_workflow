...
- [Source: _bmad-output/implementation-artifacts/3-3-implement-write-boundary-enforcement.md#Dev-Notes]
...
- `_bmad-output/implementation-artifacts/4-1-implement-story-readiness-validation-plan-generation.md` — story file
