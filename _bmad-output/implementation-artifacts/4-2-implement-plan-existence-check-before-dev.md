...
- [Source: _bmad-output/implementation-artifacts/4-1-implement-story-readiness-validation-plan-generation.md]
...
- `_bmad-output/implementation-artifacts/4-2-implement-plan-existence-check-before-dev.md` — story file
