...
- [Source: _bmad-output/planning-artifacts/prd.md#FR-21]
...
- [x] [Review][Patch] Workflow paths reference wrong directory `_scrum-output` [verification.md] - FIXED: Replaced with `_bmad-output`
