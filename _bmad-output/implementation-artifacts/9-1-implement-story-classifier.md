...
- [Source: _bmad-output/planning-artifacts/epics.md#Epic-9, Story 9.1] - Story definition with user story and BDD acceptance criteria
- [Source: _bmad-output/planning-artifacts/prd.md#FR-32] - Classification by type (feature, bugfix, refactor, infrastructure) and risk level (low, medium, high, critical)
- [Source: _bmad-output/planning-artifacts/prd.md#FR-2] - Story artifact includes type, risk_level, domain_tags in frontmatter
...
- _bmad-output/implementation-artifacts/9-1-implement-story-classifier.md — Tasks marked complete, status updated
