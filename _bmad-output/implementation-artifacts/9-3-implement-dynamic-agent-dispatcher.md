...
- [Source: _bmad-output/planning-artifacts/epics.md#Epic-9, Story 9.3] — Story definition with user story and BDD acceptance criteria
- [Source: _bmad-output/planning-artifacts/prd.md#FR-34] — Dynamic agent dispatch based on story type, risk, and domain tags
- [Source: _bmad-output/planning-artifacts/prd.md#FR-35] — Extended agent types (Security, UX, Contract) — Story 9.4, referenced by dispatch rules
- [Source: _bmad-output/planning-artifacts/prd.md#FR-12] — 3 parallel refinement agents with isolated context
...
- [Source: _bmad-output/planning-artifacts/architecture.md#Cross-Agent-Communication-Patterns] — Context isolation per agent
...
- [Source: _bmad-output/implementation-artifacts/9-2-implement-adaptive-workflow-depth-selection.md] — Previous story learnings and patterns
