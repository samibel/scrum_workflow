...
storyId: '1-8'
inputDocuments:
  - '_bmad-output/planning-artifacts/prd.md (FR-45, FR-46)'
...
| ATDD Checklist | `_bmad-output/test-artifacts/atdd-checklist-1-8.md` | This Document |
...
Alternatively, generate a traceability report via `/bmad-testarch-trace 1.8`.
