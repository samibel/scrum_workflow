...
inputDocuments: ['_bmad-output/implementation-artifacts/2-2-implement-scrum-approve-command.md', 'planning-artifacts/prd.md', 'planning-artifacts/architecture.md']
---
