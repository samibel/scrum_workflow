...
| File | Purpose |
|------|---------|
| `_bmad-output/implementation-artifacts/1-4-verify-align-wideband-delphi-estimation.md` | Story specification |
...
| `_bmad-output/test-artifacts/atdd-checklist-1-4.md` | ATDD checklist |
| `_bmad-output/planning-artifacts/prd.md` | FR-17 specification |
