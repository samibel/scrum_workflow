...
inputDocuments: ['_bmad-output/implementation-artifacts/2-2-implement-scrum-approve-command.md', '_bmad-output/test-artifacts/atdd-checklist-2.2.md']
---
...
1. Confirm artifact generation in `_bmad-output/test-artifacts/`.
