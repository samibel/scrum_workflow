...
scope: story
inputDocuments:
  - _bmad-output/implementation-artifacts/9-4-implement-extended-agent-types.md
...
traceability_and_gate:
  ...
  gate_decision:
    ...
    evidence:
      ...
      traceability: "_bmad-output/test-artifacts/traceability-report-9.4.md"
...
- **Story File:** `_bmad-output/implementation-artifacts/9-4-implement-extended-agent-types.md`
- **ATDD Checklist:** `_bmad-output/test-artifacts/atdd-checklist-9.4.md`
- **Test Files:**
