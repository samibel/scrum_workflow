...
- **Story File:** `_bmad-output/implementation-artifacts/6-3-implement-interactive-prompt-patterns.md`
...
- **UX Spec:** `_bmad-output/planning-artifacts/ux-design-specification.md` (UX-DR10, UX-DR11, UX-DR12)
