...
- **Story File:** `_bmad-output/implementation-artifacts/6-4-implement-zero-config-installation-flow.md`
- **ATDD Checklist:** `_bmad-output/test-artifacts/atdd-checklist-6-4.md`
...
- **UX Spec:** `_bmad-output/planning-artifacts/ux-design-specification.md` (UX-DR1, UX-DR4, UX-DR5)
