...
traceability_and_gate:
  ...
  gate_decision:
    ...
    evidence:
      ...
      traceability: "_bmad-output/test-artifacts/traceability/traceability-report-7-2.md"
...
- **Story File:** `_bmad-output/implementation-artifacts/7-2-implement-risk-note-extraction-auto-loading.md`
