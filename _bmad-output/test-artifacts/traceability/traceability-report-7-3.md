...
1. **Run test quality review** — Run `/bmad:tea:test-review` to assess test quality metrics for the 83-test suite (optional, informational)
...
**Test Results Source**: Dev Agent completion record in `_bmad-output/implementation-artifacts/7-3-implement-session-start-context-loading.md`
...
3. **Optional quality improvement** — Run `/bmad:tea:test-review` for detailed test quality metrics report (non-blocking).
...
- **Story File:** `_bmad-output/implementation-artifacts/7-3-implement-session-start-context-loading.md`
