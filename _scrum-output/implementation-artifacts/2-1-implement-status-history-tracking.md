...
- Alignment with unified project structure: Stories in `_scrum-output/implementation-artifacts/` or `_scrum-output/sprints/SW-XXX/` depending on implementation context.
