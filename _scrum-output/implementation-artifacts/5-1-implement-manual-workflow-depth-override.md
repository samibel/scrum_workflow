...
- [Source: _scrum-output/planning-artifacts/epics.md#Story 5.1]
...
- `_scrum-output/implementation-artifacts/5-1-implement-manual-workflow-depth-override.md` — story file created
