...
- **Source Directory**: `_scrum-output/sprints/` (note: this is the output directory, NOT `_scrum-output`)
...
4. **Workflow paths**: Use correct directory `_scrum-output` (NOT `_scrum-output`)

5. **Non-atomic status updates**: Re-read file before status update, use try/catch with ENOENT handling.

### References

- [Source: _scrum-output/planning-artifacts/epics.md#Story 8.4]
- [Source: _scrum-output/planning-artifacts/prd.md#FR-39]
...
- [Source: _scrum-output/implementation-artifacts/8-3-implement-central-audit-trail.md]
