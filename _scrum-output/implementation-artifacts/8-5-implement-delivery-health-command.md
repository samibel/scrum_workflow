...
- **Output Directory**: `_scrum-output/` (NOT `_scrum-output`)
...
- [Source: _scrum-output/planning-artifacts/epics.md#Story 8.5]
- [Source: _scrum-output/planning-artifacts/prd.md#FR-40]
...
- [Source: _scrum-output/implementation-artifacts/8-4-implement-sprint-status-command.md]
