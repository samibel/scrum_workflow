...
- [Source: _scrum-output/planning-artifacts/epics.md#Epic-9, Story 9.2] — Story definition with user story and BDD acceptance criteria
- [Source: _scrum-output/planning-artifacts/prd.md#FR-33] — Automatic workflow depth selection based on risk classification
- [Source: _scrum-output/planning-artifacts/prd.md#FR-36] — Configurable risk thresholds in config.yaml
- [Source: _scrum-output/planning-artifacts/prd.md#FR-3] — Manual depth override (`--depth light/standard`, extended to `heavy`)
- [Source: _scrum-output/planning-artifacts/prd.md#SC-12] — Process bypass rate = 0 (adaptive workflow depth works)
- [Source: _scrum-output/planning-artifacts/prd.md#UJ-5] — High-risk story gets extended treatment user journey
...
- [Source: _scrum-output/implementation-artifacts/5-1-implement-manual-workflow-depth-override.md] — Existing depth override implementation
