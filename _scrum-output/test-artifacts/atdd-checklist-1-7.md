...
| ATDD Checklist | `_scrum-output/test-artifacts/atdd-checklist-1-7.md` | This Document |
...
Alternatively, generate a traceability report via `/scrum-testarch-trace 1.7`.
