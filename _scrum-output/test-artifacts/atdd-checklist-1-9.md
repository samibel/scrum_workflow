...
storyId: '1-9'
inputDocuments:
  - '_scrum-output/planning-artifacts/prd.md (FR-46)'
  - '_scrum-output/planning-artifacts/architecture.md (Naming Patterns, Structure Patterns)'
  - '_scrum-output/implementation-artifacts/1-9-verify-align-artifact-contract.md'
...
| TC-1.9 | Story documents the _scrum-output vs _scrum-output directory delta | P0 |
...
| TC-4.2 | Delta report documents directory structure delta (_scrum-output vs _scrum-output) | P0 |
...
| TC-4.8 | Delta 1 (_scrum-output vs _scrum-output) resolution documented | P0 |
...
| ATDD Checklist | `_scrum-output/test-artifacts/atdd-checklist-1-9.md` | This Document |
...
| _scrum-output/sprints/ structure | Finding | FR-46 specifies per-story directories; current implementation uses flat files in `_scrum-output/implementation-artifacts/` — delta is documented as acceptable variance in story |
...
|-------|-------------|------------|
| Delta 1 | `_scrum-output/` vs `_scrum-output/` directory naming | ACCEPTABLE VARIANCE — Scrum Workflow-specific naming, no fix required |
