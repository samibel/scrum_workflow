...
story_id: '7.1'
inputDocuments:
  - _scrum-output/implementation-artifacts/7-1-implement-decision-record-extraction.md
  - _scrum-output/test-artifacts/atdd-checklist-7-1.md
...
| Priority | Action |
|----------|--------|
| LOW | Run `/scrum-tea-test-review` to assess test quality (routine; no coverage deficits) |
...
2. Optional: run `/scrum-tea-test-review` for test quality assessment (routine)
...
traceability_and_gate:
  ...
  traceability:
    ...
    quality:
      ...
      warning_issues: 0
    recommendations:
      - "Run /scrum-tea-test-review for routine quality assessment (no coverage deficits)"
  ...
  gate_decision:
    ...
    evidence:
      ...
      traceability: "_scrum-output/test-artifacts/traceability/traceability-report-7-1.md"
      nfr_assessment: "_scrum-output/test-artifacts/atdd-checklist-7-1.md"
...
- **Story File:** `_scrum-output/implementation-artifacts/7-1-implement-decision-record-extraction.md`
- **ATDD Checklist:** `_scrum-output/test-artifacts/atdd-checklist-7-1.md`
- **Implementation:** `scrum_workflow/utils/decision-extraction.js`
