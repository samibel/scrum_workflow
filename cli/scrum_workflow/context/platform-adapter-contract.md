...
**Source Documents:**
- Architecture Decision Document: [Source: _scrum-output/context/architecture.md#Decision-6-Platform-Adapter-Contract]
- Framework Distribution: [Source: _scrum-output/context/architecture.md#Decision-7-Framework-Distribution-Path-Referencing]
- Three-Layer Separation: [Source: _scrum-output/context/architecture.md#Three-Layer-Separation]
