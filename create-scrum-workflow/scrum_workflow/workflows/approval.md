...
Fix: Run code review first: '/scrum-dev-story SW-XXX review'
```
...
3. Provide instructions for next steps:
   ...
   3. Re-trigger review: '/scrum-dev-story SW-XXX review'
...
2. Developer triggers new review: `/scrum-dev-story SW-XXX review`
