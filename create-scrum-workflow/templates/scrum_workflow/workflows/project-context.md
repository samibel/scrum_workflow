...
Two-phase workflow for the `/scrum-create-project-context` command. Phase A collects facts via shell commands (no hallucination). Phase B fills templates with collected facts and writes output files.
