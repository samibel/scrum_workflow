...
import {
  ...
  STATUS_PRIORITY,
  PENDING_ACTION_MAP
} from '../../../src/utils/sprint-status.js';

const TEST_DIR = dirname(fileURLToPath(import.meta.url));
const PROJECT_ROOT = join(TEST_DIR, '..', '..', '..');
const TEST_PROJECT_ROOT = join(PROJECT_ROOT, 'tests', 'unit', 'sprint-status', 'test-fixtures', 'sprint-status-project');
...
function cleanupTestFixtures() {
  try {
    ...
    const testFixturesDir = join(PROJECT_ROOT, 'tests', 'unit', 'sprint-status', 'test-fixtures');
