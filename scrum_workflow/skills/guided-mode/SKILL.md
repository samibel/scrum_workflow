...
This skill never writes files directly. It returns clarifying questions to the orchestrating command (`/create-ticket`), which manages the conversation loop and eventual story file creation.
