...
inputDocuments:
  - _bmad-output/implementation-artifacts/5-2-implement-cli-update-migration-command.md
...
| `_bmad-output/implementation-artifacts/5-2-implement-cli-update-migration-command.md` | MODIFY |
