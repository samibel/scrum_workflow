...
|---------|--------------|
| `/scrum-create-ticket` | Create a new story from epic requirements |
| `/scrum-refine-ticket SW-XXX` | Multi-agent refinement of story details |
| `/scrum-dev-story SW-XXX` | Implement the story (requires status: ready) |
| `/scrum-dev-story SW-XXX review` | Trigger code review (after implementation) |
...
stateDiagram-v2
    ...
    Draft --> Refinement: /scrum-refine-ticket SW-XXX
    Refinement --> Ready: Readiness Check PASSED
    Refinement --> Draft: Readiness Check FAIL
    Ready --> InDev: /scrum-dev-story SW-XXX
    InDev --> InReview: /scrum-dev-story SW-XXX review
...
/scrum-dev-story SW-XXX  # Will fail if not ready

# Right: Complete refinement first
/scrum-refine-ticket SW-XXX  # Then /scrum-dev-story
```
...
/scrum-dev-story SW-XXX review  # Then approve
```
...
/scrum-refine-ticket SW-XXX  # Regenerates plan.md
```
...
```bash
# Trigger new review
/scrum-dev-story SW-XXX review  # Creates review-(N+1).md
```
