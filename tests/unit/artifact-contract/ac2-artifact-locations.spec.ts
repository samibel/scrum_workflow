...
describe('AC2: /scrum-create-ticket — story.md artifact specification', () => {
  ...
  test.skip('[P0] create-ticket command file should exist', () => {
    expect(existsSync(commandFile)).toBe(true);
  });

  // Test 2.2: create-ticket command specifies story.md output
  test.skip('[P0] create-ticket command should specify story.md as output artifact', () => {
  ...
  test.skip('[P0] create-ticket command should specify _scrum-output/sprints/SW-XXX/ as output location', () => {
    const content = readFileSync(commandFile, 'utf8');
  ...
  test.skip('[P0] ticket-creation workflow should reference _scrum-output/sprints/ directory', () => {
  ...
  test.skip('[P1] create-ticket command should document required YAML frontmatter fields', () => {
    const content = readFileSync(commandFile, 'utf8');
...
describe('AC2: /scrum-refine-ticket — refinement.md artifact specification', () => {
  ...
  test.skip('[P0] refine-ticket command file should exist', () => {
    expect(existsSync(commandFile)).toBe(true);
  });

  // Test 2.7: refine-ticket workflow file exists
  test.skip('[P0] refinement workflow file should exist', () => {
    expect(existsSync(workflowFile)).toBe(true);
  });

  // Test 2.8: refinement workflow references _scrum-output/sprints/
  test.skip('[P0] refinement workflow should reference _scrum-output/sprints/ as output location', () => {
    const content = readFileSync(workflowFile, 'utf8');
...
describe('AC2: /scrum-refine-story — plan.md artifact specification', () => {
  ...
  test.skip('[P0] refine-story command file should exist', () => {
    expect(existsSync(commandFile)).toBe(true);
  });

  // Test 2.10: readiness-check workflow file exists
  test.skip('[P0] readiness-check workflow file should exist', () => {
    expect(existsSync(workflowFile)).toBe(true);
  });
});
...
describe('AC2: /scrum-dev-story — source code write boundary', () => {
  ...
  test.skip('[P0] dev-story command file should exist', () => {
    expect(existsSync(commandFile)).toBe(true);
  });

  // Test 2.12: development workflow file exists
  test.skip('[P0] development workflow file should exist', () => {
    expect(existsSync(workflowFile)).toBe(true);
  });

  // Test 2.13: dev-story command does NOT reference artifact output directories
  test.skip('[P0] dev-story command should NOT create artifacts in _scrum-output/sprints/ (source code only)', () => {
    expect(existsSync(commandFile)).toBe(true);
    const content = readFileSync(commandFile, 'utf8');
    // dev-story writes source code, not sprint artifacts
    // It should NOT specify story.md, refinement.md, or plan.md as its output
    expect(content).not.toMatch(/Output.*story\.md|Output.*refinement\.md|Output.*plan\.md/i);
  });

  // Test 2.14: development workflow specifies source code as output (not sprint artifacts)
  test.skip('[P0] development workflow should reference source code as output (not sprint artifacts)', () => {
    const content = readFileSync(workflowFile, 'utf8');
...
describe('AC2: /scrum-review-story — review-N.md artifact specification', () => {
  ...
  test.skip('[P0] review-story command file should exist', () => {
    expect(existsSync(commandFile)).toBe(true);
  });

  // Test 2.16: review-story workflow file exists
  test.skip('[P0] review-story workflow file should exist', () => {
    expect(existsSync(workflowFile)).toBe(true);
  });

  // Test 2.17: review-story command references review-N.md naming
  test.skip('[P0] review-story command should reference review-N.md naming convention', () => {
    const content = readFileSync(commandFile, 'utf8');
  ...
  test.skip('[P0] review-story command should specify _scrum-output/sprints/SW-XXX/ as output location', () => {
    const content = readFileSync(commandFile, 'utf8');
    expect(content).toMatch(/_scrum-output\/sprints/);
  });
});
...
describe('AC2: /scrum-research-* — RR-XXX.md artifact specification', () => {
  ...
  test.skip('[P0] research-technical command should reference _scrum-output/memory/research/ as output location', () => {
    const content = readFileSync(technicalCommandFile, 'utf8');
  ...
  test.skip('[P0] research-general command should reference _scrum-output/memory/research/ as output location', () => {
    const content = readFileSync(generalCommandFile, 'utf8');
    expect(content).toMatch(/_scrum-output\/memory\/research/);
  });

  // Test 2.24: research-technical workflow references correct output path
  test.skip('[P0] research-technical workflow should reference _scrum-output/memory/research/ as output path', () => {
...
describe('AC2: Deferred Commands — /scrum-approve, /wrap-up, /session-start', () => {
  ...
  test.skip('[P0] Story should document /scrum-approve as deferred to Epic 2', () => {
  ...
  test.skip('[P0] Story should document /wrap-up as deferred to Epic 7', () => {
    const content = readFileSync(storyFile, 'utf8');
  ...
  test.skip('[P0] Story should document /session-start as deferred to Epic 7', () => {
    const content = readFileSync(storyFile, 'utf8');
...
describe('AC2: _scrum-output Directory Structure Verification', () => {
  ...
  test.skip('[P0] _scrum-output directory should exist at project root', () => {
  ...
  test.skip('[P0] _scrum-output/memory/research/ directory should exist', () => {
