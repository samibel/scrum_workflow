...
describe('AC1: SKILL.md — Architecture-standard error format for all guard failures', () => {
  ...
  test.skip('[P0] SKILL.md should use ❌ Status Guard Violation: prefix for all guard errors', () => {
  ...
  test.skip('[P0] SKILL.md create-ticket guard error should use ❌ Status Guard Violation: format', () => {
    const content = readFileSync(SKILL_FILE, 'utf8');
  ...
  test.skip('[P0] SKILL.md refine-ticket guard error should use ❌ Status Guard Violation: format', () => {
    const content = readFileSync(SKILL_FILE, 'utf8');
  ...
  test.skip('[P0] SKILL.md refine-story guard error should use ❌ Status Guard Violation: format', () => {
    const content = readFileSync(SKILL_FILE, 'utf8');
  ...
  test.skip('[P0] SKILL.md dev-story guard error should use ❌ Status Guard Violation: format', () => {
    const content = readFileSync(SKILL_FILE, 'utf8');
  ...
  test.skip('[P0] SKILL.md dev-story guard should accept both ready-for-dev and changes-needed', () => {
    const content = readFileSync(SKILL_FILE, 'utf8');
    const devStorySection = content.match(/Dev Story Command[\s\S]*?(?=###|\n## )/i);
    expect(devStorySection).not.toBeNull();
  ...
  test.skip('[P0] SKILL.md review-story guard error should use ❌ Status Guard Violation: format', () => {
    const content = readFileSync(SKILL_FILE, 'utf8');
  ...
  test.skip('[P0] SKILL.md approval guard error should use ❌ Status Guard Violation: format', () => {
    const content = readFileSync(SKILL_FILE, 'utf8');
  ...
  test.skip('[P0] SKILL.md guard errors should include **Details:** section', () => {
    const content = readFileSync(SKILL_FILE, 'utf8');
  ...
  test.skip('[P0] SKILL.md guard errors should include **Next Step:** section', () => {
    const content = readFileSync(SKILL_FILE, 'utf8');
  ...
  test.skip('[P1] SKILL.md should NOT use plain Error: prefix for guard failures', () => {
    const content = readFileSync(SKILL_FILE, 'utf8');
...
describe('AC1: dev-story.md — standard error format in Guard Condition Enforcement', () => {
  ...
  test.skip('[P0] commands/dev-story.md should exist', () => {
    expect(existsSync(DEV_STORY_CMD)).toBe(true);
  });

  // Test 1.14: dev-story.md Guard Condition Enforcement uses standard format
  test.skip('[P0] commands/dev-story.md Guard Condition Enforcement should use ❌ Status Guard Violation: format', () => {
    const content = readFileSync(DEV_STORY_CMD, 'utf8');
    expect(content).toMatch(/❌ Status Guard Violation:/);
  });

  // Test 1.15: dev-story.md references both valid statuses
  test.skip('[P0] commands/dev-story.md should reference both ready-for-dev and changes-needed as valid statuses', () => {
    const content = readFileSync(DEV_STORY_CMD, 'utf8');
...
describe('AC1: approve.md — standard error format in Error Handling', () => {
  ...
  test.skip('[P0] commands/approve.md should exist', () => {
    expect(existsSync(APPROVE_CMD)).toBe(true);
  });

  // Test 1.17: approve.md uses standard error format
  test.skip('[P0] commands/approve.md Error Handling should use ❌ Status Guard Violation: format', () => {
...
describe('AC1: review-story.md — standard error format', () => {
  ...
  test.skip('[P0] commands/review-story.md should use ❌ Status Guard Violation: format', () => {
...
describe('AC1: refine-ticket.md, refine-story.md, create-ticket.md — standard error format', () => {
  ...
  test.skip('[P0] commands/refine-ticket.md should use ❌ Status Guard Violation: format', () => {
    const content = readFileSync(REFINE_TICKET_CMD, 'utf8');
    expect(content).toMatch(/❌ Status Guard Violation:/);
  });

  // Test 1.20: refine-story.md uses standard error format
  test.skip('[P0] commands/refine-story.md should use ❌ Status Guard Violation: format', () => {
    const content = readFileSync(REFINE_STORY_CMD, 'utf8');
    expect(content).toMatch(/❌ Status Guard Violation:/);
  });

  // Test 1.21: create-ticket.md uses standard error format
  test.skip('[P0] commands/create-ticket.md should use ❌ Status Guard Violation: format', () => {
