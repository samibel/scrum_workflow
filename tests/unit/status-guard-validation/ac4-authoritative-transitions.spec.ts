...
describe('AC4: SKILL.md — References standards.md as authoritative transitions source', () => {
  ...
  test.skip('[P0] scrum_workflow/context/standards.md should exist', () => {
  ...
  test.skip('[P0] SKILL.md should explicitly reference standards.md as the authoritative transitions source', () => {
  ...
  test.skip('[P0] SKILL.md should reference standards.md for transitions, not re-define them independently', () => {
    const content = readFileSync(SKILL_FILE, 'utf8');
  ...
  test.skip('[P0] SKILL.md should state only explicitly defined transitions are permitted', () => {
    const content = readFileSync(SKILL_FILE, 'utf8');
  ...
  test.skip('[P0] SKILL.md valid status values should include all 9 states', () => {
    const content = readFileSync(SKILL_FILE, 'utf8');
  ...
  test.skip('[P0] SKILL.md should include any→cancelled transition', () => {
    const content = readFileSync(SKILL_FILE, 'utf8');
  ...
  test.skip('[P0] SKILL.md should state that transitions not in the list are blocked', () => {
    const content = readFileSync(SKILL_FILE, 'utf8');
  ...
  test.skip('[P1] SKILL.md should document refinement as implementation-internal sub-state', () => {
    const content = readFileSync(SKILL_FILE, 'utf8');
  ...
  test.skip('[P0] SKILL.md should state the guard checks requested transitions against standards.md', () => {
    const content = readFileSync(SKILL_FILE, 'utf8');
...
describe('AC4: standards.md — Contains the authoritative valid transitions list', () => {
  ...
  test.skip('[P0] standards.md should contain a Valid Transitions table or section', () => {
    const content = readFileSync(STANDARDS_FILE, 'utf8');
  ...
  test.skip('[P0] standards.md Valid Transitions should cover all 9 lifecycle states', () => {
    const content = readFileSync(STANDARDS_FILE, 'utf8');
    expect(content).toMatch(/\bdraft\b/);
    expect(content).toMatch(/\brefined\b/);
    expect(content).toMatch(/\bready-for-dev\b/);
  ...
  test.skip('[P0] standards.md Valid Transitions should include any→cancelled', () => {
    const content = readFileSync(STANDARDS_FILE, 'utf8');
    expect(content).toMatch(/any.*cancelled|any →.*cancelled|`any`.*`cancelled`/i);
  });
});
