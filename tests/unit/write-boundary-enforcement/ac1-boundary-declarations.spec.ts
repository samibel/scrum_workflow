...
describe('AC1: create-ticket.md — Write Boundary Rules section', () => {
  ...
  test('[P0] commands/create-ticket.md should exist', () => {
    expect(existsSync(CREATE_TICKET_CMD)).toBe(true);
  });

  // Test 1.2: create-ticket.md has ## Write Boundary Rules section
  test('[P0] commands/create-ticket.md should have ## Write Boundary Rules section', () => {
  ...
  test('[P0] commands/create-ticket.md should declare "This workflow may write"', () => {
    const content = readFileSync(CREATE_TICKET_CMD, 'utf8');
    expect(content).toMatch(/This workflow may write/);
  });

  // Test 1.4: create-ticket.md declares "may NOT write" list
  test('[P0] commands/create-ticket.md should declare "This workflow may NOT write"', () => {
    const content = readFileSync(CREATE_TICKET_CMD, 'utf8');
    expect(content).toMatch(/This workflow may NOT write/);
  });

  // Test 1.5: create-ticket.md specifies story.md as allowed write target
  test('[P0] commands/create-ticket.md Write Boundary should specify story.md as allowed write', () => {
    const content = readFileSync(CREATE_TICKET_CMD, 'utf8');
  ...
  test('[P1] commands/create-ticket.md Write Boundary should reference status: draft', () => {
    const content = readFileSync(CREATE_TICKET_CMD, 'utf8');
    const wbSection = content.match(/## Write Boundary Rules[\s\S]*/);
    expect(wbSection).not.toBeNull();
  ...
  test('[P0] commands/create-ticket.md Write Boundary should prohibit refinement.md, plan.md', () => {
    const content = readFileSync(CREATE_TICKET_CMD, 'utf8');
    const wbSection = content.match(/## Write Boundary Rules[\s\S]*/);
    expect(wbSection).not.toBeNull();
...
describe('AC1: refine-ticket.md — Write Boundary Rules section', () => {
  ...
  test('[P0] commands/refine-ticket.md should have ## Write Boundary Rules section', () => {
    const content = readFileSync(REFINE_TICKET_CMD, 'utf8');
    expect(content).toMatch(/## Write Boundary Rules/);
  });

  // Test 1.9: refine-ticket.md declares "may write" list
  test('[P0] commands/refine-ticket.md should declare "This workflow may write"', () => {
    const content = readFileSync(REFINE_TICKET_CMD, 'utf8');
    expect(content).toMatch(/This workflow may write/);
  });

  // Test 1.10: refine-ticket.md declares "may NOT write" list
  test('[P0] commands/refine-ticket.md should declare "This workflow may NOT write"', () => {
    const content = readFileSync(REFINE_TICKET_CMD, 'utf8');
    expect(content).toMatch(/This workflow may NOT write/);
  });

  // Test 1.11: refine-ticket.md specifies refinement.md as allowed write target
  test('[P0] commands/refine-ticket.md Write Boundary should allow writing refinement.md', () => {
    const content = readFileSync(REFINE_TICKET_CMD, 'utf8');
    const wbSection = content.match(/## Write Boundary Rules[\s\S]*/);
    expect(wbSection).not.toBeNull();
  ...
  test('[P1] commands/refine-ticket.md Write Boundary should allow story.md for status/synthesis', () => {
    const content = readFileSync(REFINE_TICKET_CMD, 'utf8');
    const wbSection = content.match(/## Write Boundary Rules[\s\S]*/);
    expect(wbSection).not.toBeNull();
    expect(wbSection![0]).toMatch(/story\.md/);
  ...
  test('[P0] commands/refine-ticket.md Write Boundary should prohibit plan.md', () => {
    const content = readFileSync(REFINE_TICKET_CMD, 'utf8');
    const wbSection = content.match(/## Write Boundary Rules[\s\S]*/);
    expect(wbSection).not.toBeNull();
...
describe('AC1: refine-story.md — Write Boundary Rules section (bug fix)', () => {
  ...
  test('[P0] commands/refine-story.md should have ## Write Boundary Rules section', () => {
  ...
  test('[P0] commands/refine-story.md Write Boundary "may write" should include plan.md (bug fix)', () => {
    const content = readFileSync(REFINE_STORY_CMD, 'utf8');
    const wbSection = content.match(/## Write Boundary Rules[\s\S]*/);
    expect(wbSection).not.toBeNull();
  ...
  test('[P0] commands/refine-story.md Write Boundary "may NOT write" should NOT include plan.md', () => {
    const content = readFileSync(REFINE_STORY_CMD, 'utf8');
    const wbSection = content.match(/## Write Boundary Rules[\s\S]*/);
    expect(wbSection).not.toBeNull();
  ...
  test('[P0] commands/refine-story.md should declare "This workflow may write"', () => {
    const content = readFileSync(REFINE_STORY_CMD, 'utf8');
    expect(content).toMatch(/This workflow may write/);
  });

  // Test 1.18: refine-story.md declares "may NOT write" list
  test('[P0] commands/refine-story.md should declare "This workflow may NOT write"', () => {
    const content = readFileSync(REFINE_STORY_CMD, 'utf8');
    expect(content).toMatch(/This workflow may NOT write/);
  });
});
...
describe('AC1: dev-story.md — Write Boundary Rules section', () => {
  ...
  test('[P0] commands/dev-story.md should have ## Write Boundary Rules section', () => {
    const content = readFileSync(DEV_STORY_CMD, 'utf8');
    expect(content).toMatch(/## Write Boundary Rules/);
  });

  // Test 1.20: dev-story.md declares "may write" list
  test('[P0] commands/dev-story.md should declare "This workflow may write"', () => {
    const content = readFileSync(DEV_STORY_CMD, 'utf8');
    expect(content).toMatch(/This workflow may write/);
  });

  // Test 1.21: dev-story.md declares "may NOT write" list
  test('[P0] commands/dev-story.md should declare "This workflow may NOT write"', () => {
    const content = readFileSync(DEV_STORY_CMD, 'utf8');
    expect(content).toMatch(/This workflow may NOT write/);
  });

  // Test 1.22: dev-story.md "may write" includes source code and test files
  test('[P0] commands/dev-story.md Write Boundary should allow source code and test files', () => {
    const content = readFileSync(DEV_STORY_CMD, 'utf8');
    const wbSection = content.match(/## Write Boundary Rules[\s\S]*/);
    expect(wbSection).not.toBeNull();
  ...
  test('[P0] commands/dev-story.md Write Boundary should allow story.md for status field only', () => {
    const content = readFileSync(DEV_STORY_CMD, 'utf8');
    const wbSection = content.match(/## Write Boundary Rules[\s\S]*/);
    expect(wbSection).not.toBeNull();
    expect(wbSection![0]).toMatch(/story\.md/);
  ...
  test('[P0] commands/dev-story.md Write Boundary should prohibit plan.md and refinement.md', () => {
    const content = readFileSync(DEV_STORY_CMD, 'utf8');
    const wbSection = content.match(/## Write Boundary Rules[\s\S]*/);
    expect(wbSection).not.toBeNull();
    expect(wbSection![0]).toMatch(/plan\.md/);
...
describe('AC1: review-story.md — Write Boundary Rules section', () => {
  ...
  test('[P0] commands/review-story.md should have ## Write Boundary Rules section', () => {
    const content = readFileSync(REVIEW_STORY_CMD, 'utf8');
    expect(content).toMatch(/## Write Boundary Rules/);
  });

  // Test 1.26: review-story.md declares "may write" and "may NOT write"
  test('[P0] commands/review-story.md should declare may write and may NOT write lists', () => {
    const content = readFileSync(REVIEW_STORY_CMD, 'utf8');
    expect(content).toMatch(/This workflow may write/);
    expect(content).toMatch(/This workflow may NOT write/);
  });
  ...
  test('[P0] commands/review-story.md Write Boundary should allow review-N.md', () => {
    const content = readFileSync(REVIEW_STORY_CMD, 'utf8');
    const wbSection = content.match(/## Write Boundary Rules[\s\S]*/);
    expect(wbSection).not.toBeNull();
  ...
  test('[P0] commands/review-story.md Write Boundary should prohibit source code writes', () => {
    const content = readFileSync(REVIEW_STORY_CMD, 'utf8');
    const wbSection = content.match(/## Write Boundary Rules[\s\S]*/);
    expect(wbSection).not.toBeNull();
...
describe('AC1: approve.md — Write Boundary Rules section', () => {
  ...
  test('[P0] commands/approve.md should have ## Write Boundary Rules section', () => {
    const content = readFileSync(APPROVE_CMD, 'utf8');
    expect(content).toMatch(/## Write Boundary Rules/);
  });

  // Test 1.30: approve.md declares "may write" and "may NOT write"
  test('[P0] commands/approve.md should declare may write and may NOT write lists', () => {
    const content = readFileSync(APPROVE_CMD, 'utf8');
    expect(content).toMatch(/This workflow may write/);
    expect(content).toMatch(/This workflow may NOT write/);
  });
  ...
  test('[P0] commands/approve.md Write Boundary should allow approval-N.md', () => {
    const content = readFileSync(APPROVE_CMD, 'utf8');
    const wbSection = content.match(/## Write Boundary Rules[\s\S]*/);
    expect(wbSection).not.toBeNull();
  ...
  test('[P0] commands/approve.md Write Boundary should allow story.md status update', () => {
    const content = readFileSync(APPROVE_CMD, 'utf8');
    const wbSection = content.match(/## Write Boundary Rules[\s\S]*/);
    expect(wbSection).not.toBeNull();
    expect(wbSection![0]).toMatch(/story\.md/);
