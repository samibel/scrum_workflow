...
describe('AC3: create-ticket.md — halt-and-report on write boundary violation', () => {
  ...
  test('[P0] commands/create-ticket.md Write Boundary should instruct agent to halt on violation', () => {
  ...
  test('[P0] commands/create-ticket.md Write Boundary should instruct agent to report violation', () => {
    const content = readFileSync(CREATE_TICKET_CMD, 'utf8');
    const wbSection = content.match(/## Write Boundary Rules[\s\S]*/);
    expect(wbSection).not.toBeNull();
...
describe('AC3: refine-ticket.md — halt-and-report on write boundary violation', () => {
  ...
  test('[P0] commands/refine-ticket.md Write Boundary should instruct agent to halt on violation', () => {
...
describe('AC3: dev-story.md — halt-and-report on write boundary violation', () => {
  ...
  test('[P0] commands/dev-story.md Write Boundary should instruct agent to halt on violation', () => {
  ...
  test('[P0] commands/dev-story.md Write Boundary should instruct agent to report violation to user', () => {
    const content = readFileSync(DEV_STORY_CMD, 'utf8');
    const wbSection = content.match(/## Write Boundary Rules[\s\S]*/);
    expect(wbSection).not.toBeNull();
...
describe('AC3: review-story.md — halt-and-report on write boundary violation', () => {
  ...
  test('[P0] commands/review-story.md Write Boundary should instruct agent to halt on violation', () => {
...
describe('AC3: approve.md — halt-and-report on write boundary violation', () => {
  ...
  test('[P0] commands/approve.md Write Boundary should instruct agent to halt on violation', () => {
...
describe('AC3: refine-story.md — halt-and-report on write boundary violation', () => {
  ...
  test('[P0] commands/refine-story.md Write Boundary should instruct agent to halt on violation', () => {
...
describe('AC3: workflows/approval.md — standard error format in Step 6.3', () => {
  ...
  test('[P0] workflows/approval.md Step 6.3 should use ❌ Write Boundary Violation: prefix', () => {
  ...
  test('[P0] workflows/approval.md Step 6.3 should NOT use plain "Error: Write boundary violation" format', () => {
    const content = readFileSync(APPROVAL_WORKFLOW, 'utf8');
  ...
  test('[P0] workflows/approval.md Write Boundary Violation error should include **Details:**', () => {
    const content = readFileSync(APPROVAL_WORKFLOW, 'utf8');
  ...
  test('[P0] workflows/approval.md Write Boundary Violation error should include **Next Step:**', () => {
    const content = readFileSync(APPROVAL_WORKFLOW, 'utf8');
    const step63Section = content.match(/Step 6\.3[\s\S]*?(?=## Step 6\.|##\s+Step 7|$)/i);
    expect(step63Section).not.toBeNull();
  ...
  test('[P0] workflows/approval.md Write Boundary Violation error should reference the file_path', () => {
    const content = readFileSync(APPROVAL_WORKFLOW, 'utf8');
...
describe('AC3: Named anti-patterns from Architecture appear in correct command files', () => {
  ...
  test('[P0] "Spec Drift" anti-pattern should appear in commands/dev-story.md', () => {
    const content = readFileSync(DEV_STORY_CMD, 'utf8');
    expect(content).toMatch(/Spec Drift/);
  });

  // Test 3.15: Self-Fix appears in review-story.md (review command)
  test('[P0] "Self-Fix" anti-pattern should appear in commands/review-story.md', () => {
    const content = readFileSync(REVIEW_STORY_CMD, 'utf8');
    expect(content).toMatch(/Self-Fix/);
  });

  // Test 3.16: Bounded Authority Violation appears in approve.md (approval command)
  test('[P0] "Bounded Authority Violation" anti-pattern should appear in commands/approve.md', () => {
    const content = readFileSync(APPROVE_CMD, 'utf8');
  ...
  test('[P0] All 6 command files should have Write Boundary Rules with halt instruction', () => {
    const commandFiles = [
